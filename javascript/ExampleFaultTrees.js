var ExampleFaultTrees = (function () {
    function ExampleFaultTrees() {
		...
		this.addFaultTree(this.generateMyExample1());
		this.addFaultTree(this.generateMyExample2());
	...
	// ********************************** Additional examples to test the get depth function ********************
	
	ExampleFaultTrees.prototype.generateMyExample1 = function () {
		var topNode = new AndGate();
		...
		var event1 = new BasicEvent();
		topNode.addChild(event1);
		
		var event2 = new BasicEvent();
		topNode.addChild(event2);
	...
	ExampleFaultTrees.prototype.generateMyExample2 = function () {
		var topNode = new AndGate();
